...
export default function MainDataView() {
    ...
    return (
        <main className="flex-1 flex flex-col min-w-0 bg-[#0a0a0a] relative">
            <div className="h-[44px] border-b border-[#222] bg-[#111] flex items-center justify-between px-4 shrink-0 transition-colors">
                <div className="flex items-center gap-2 overflow-x-auto custom-scrollbar-hidden mr-4">
                ...
                <div className="flex items-center shrink-0 gap-3">
                    ...
                    <div className="relative">
                        <button 
                            ...
                            disabled={pages.length === 0}
                            className="flex items-center gap-1.5 px-3 py-1 bg-[#0a0a0a] hover:bg-[#1a1a1a] border border-[#222] rounded text-[11px] font-medium text-[#888] transition-colors disabled:opacity-30 disabled:cursor-not-allowed hover:text-white"
                        >
                            ...
                            <tr className="text-[#999] font-medium text-[11px]">
                                <th className="py-2 px-1.5 w-[30px] border-r border-b border-[#222] sticky left-0 bg-[#111] z-20">
                                    <input
                                        ...
                                        onChange={(e) => {
                                            if (e.target.checked) {
                                                setSelectedRows(new Set(filteredPages.map(p => p.url)));
                                            } else {
