...
const CHECK_CATEGORY_TO_TREE_IDS: Record<CheckCategory, string[]> = {
    ...
    social_audit: ['content'],
    competitor: ['ai-insights'],
    citations_reviews: ['links'],
    ads_ppc: ['ai-insights'],
    conversion_ux: ['ai-insights'],
    tech_debt_compliance: ['security', 'performance'],
    ecommerce_specific: ['schema', 'content'],
    local_specific: ['international', 'schema'],
    news_specific: ['content', 'schema'],
    saas_specific: ['content', 'ai-insights'],
    healthcare_specific: ['content'],
